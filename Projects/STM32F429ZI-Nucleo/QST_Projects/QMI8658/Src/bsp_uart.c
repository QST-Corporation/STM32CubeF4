...
#define USART_STDIO_UART                      USART3
#define USART_STDIO_CLK_ENABLE()              __HAL_RCC_USART3_CLK_ENABLE();
#define USART_STDIO_RX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOD_CLK_ENABLE()
#define USART_STDIO_TX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOD_CLK_ENABLE() 

#define USART_STDIO_FORCE_RESET()             __HAL_RCC_USART3_FORCE_RESET()
#define USART_STDIO_RELEASE_RESET()           __HAL_RCC_USART3_RELEASE_RESET()

/* Definition for USART_STDIO Pins */
#define USART_STDIO_TX_PIN                    GPIO_PIN_8
#define USART_STDIO_TX_GPIO_PORT              GPIOD
#define USART_STDIO_TX_AF                     GPIO_AF7_USART3
#define USART_STDIO_RX_PIN                    GPIO_PIN_9
#define USART_STDIO_RX_GPIO_PORT              GPIOD
#define USART_STDIO_RX_AF                     GPIO_AF7_USART3
